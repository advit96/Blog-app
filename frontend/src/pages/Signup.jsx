...
export default function Signup() {
  ...
  return (
    <div className="mx-auto max-w-sm">
      ...
      <p className="mb-4 text-sm text-gray-600">It only takes a minute.</p>
      <form onSubmit={onSubmit} className="space-y-4">
        <div className="space-y-1">
          <label className="block text-sm text-gray-600">Name</label>
          <input className="w-full rounded-md border px-3 py-2 outline-none focus:ring-2 focus:ring-gray-300" value={name} onChange={(e) => setName(e.target.value)} required />
        </div>
        <div className="space-y-1">
        ...
        <button type="submit" className="w-full rounded-md bg-gray-900 text-white py-2 shadow hover:bg-black">Create account</button>
      </form>
